...
import { Box, Card, Container, CssBaseline, Grid, PaletteMode, TextField, ThemeProvider, Typography, createTheme } from '@mui/material';
...
function App() {
  ...
  function getCurrentPaletteMode() {
    return localStorage.getItem(LS_PALETTE_MODE_KEY) || (window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches ? 'dark' : 'light');
  }
